...
def parse_lammps_data(data_path, settings_path):
    ...
    # Step 2: Exclude bonded (1–2) and angled (1–3) pairs
    ...
    # Keep only pairs that aren't excluded
    ...
    # Step 3: Mark 1–4 interactions from torsions
    ...
    box = jnp.array([54.0, 54.0, 54.0])  # Ideally parse from file header
